...
route::get('/toDeliver/{id}',[AdminController::class,'toDeliver']);
...
route::get('/nearExpiry_product',[AdminController::class,'nearExpiry_product'])->name('nearExpiry_product');;
...
route::get('/view_spin',[HomeController::class,'view_spin']);
route::get('/view_scratch',[HomeController::class,'view_scratch']);
route::get('/view_quiz',[HomeController::class,'view_quiz']);
