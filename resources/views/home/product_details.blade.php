            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="d-flex align-items-center">    
                        ...
                        <ul>
                            <li><b>Expiry Date</b><span>{{ \Carbon\Carbon::parse($product->expiry_date)->format('F d, Y') }}</span></li>
                            <li><b>Availability</b> <span>In Stock: {{$product->quantity}}</span></li>
                            <li><b>Delivery</b> <span>Every Thursday and Friday, <samp>Free pickup today</samp></span></li>
                            <li><b>Share on</b>
                                <div class="share">
