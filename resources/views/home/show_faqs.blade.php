...
<head>
    ...
    <style>
        ...
        .btn-link {
        color: #EDBB0E; /* Change to your desired color */
        font-weight: bold; /* Optional for styling */
        text-decoration: none; /* Remove underline if needed */
        }

        .btn-link:hover {
            color: #735c09; /* Change color on hover */
        ...
        <div id="faqAccordion" class="accordion">
            ...
            <div class="card">
                ...
                <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#faqAccordion">
                    <div class="card-body">
                        PA-BUY is an online shopping platform designed for Dairy Box Businesses. It allows customers to purchase a variety of dairy and related products conveniently online.
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card">
                    ...
                    <div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#faqAccordion">
                        <div class="card-body">
                            PA-BUY currently accepts Cash on Delivery (COD) and cash payments for walk-in customers only. This ensures a secure and convenient payment option, particularly for local deliveries and in-store purchases.
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-header" id="heading10">
                        <h5 class="mb-0">
                            <button class="btn btn-link faq-question collapsed" data-toggle="collapse" data-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                                How secure is my account on PA-BUY?
                            </button>
                        </h5>
                    </div>
                    <div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#faqAccordion">
                        <div class="card-body">
                            PA-BUY uses End-to-End Encryption to protect your data and Two-Factor Authentication (2FA) that adds extra security during sign-in and purchase confirmations.
                        </div>
                    </div>
                </div>
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div id="collapse12" class="collapse" aria-labelledby="heading12" data-parent="#faqAccordion">
                        <div class="card-body">
                            PA-BUY does not allow returns or refunds, as the products are perishable and have limited shelf lives. All sales are final, so please double-check your order details before completing your purchase. For any issues with your order, you may contact the seller directly for assistance.
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" id="heading13">
                        <h5 class="mb-0">
                            <button class="btn btn-link faq-question collapsed" data-toggle="collapse" data-target="#collapse13" aria-expanded="false" aria-controls="collapse13">
                                How do I filter products to find what I want?
                            </button>
                        </h5>
                    </div>
                    <div id="collapse13" class="collapse" aria-labelledby="heading13" data-parent="#faqAccordion">
                        <div class="card-body">
                            Use the Product Filtering options within the Ordering Module to search by category, price range, product type, and availability.
                        </div>
                    </div>
                </div>
            </div>
