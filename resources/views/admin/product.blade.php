                        ...
                        <form action="{{url('/add_product')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div id="flavor-size-container">
                                <div class="flavor-size-row">
                                    ...
                                    <div class="d-flex gap-2 mb-2 mt-2">
                                        <button style="margin-left: 40%" class="addBTN" type="button" onclick="addFlavorSizeRow()">Add Flavor & Size</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" name="discount" placeholder="Write a discount">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label>Product delivery qty.: </label>
                                    <input type="number" min="0" name="delivery" placeholder="Write a delivery"  required="">
                                </div>
                            </div>
