							        ...
							        <table class="table mb-0 text-left">
										...
										<tbody>
											...
											<tr>
                                               ...
                                               <!-- <td class="cell">		
													<a class="btn-sm app-btn-secondary" href="{{url('toDeliver',$delivery->id)}}" 
														onclick="return confirm('Are you sure this order was delivered?')">Delivered?</a>
												</td> -->
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table mb-0 text-left">
										...
										<tbody>
											@foreach ($completed as $compOrders)
