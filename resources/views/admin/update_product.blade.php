                    ...
                    <form action="{{url('/update_product_confirm',$product->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="discount" placeholder="Write a discount" value="{{$product->discount_price}}">
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-lg-3">
                                <label>Change Product stock: </label>
                            ...
                            <div class="col-lg-6">
                                <label>Change Product delivery qty.: </label>
                                <input type="number" min="0" name="delivery" placeholder="Write a delivery" required="" value="{{$product->delivery_qty}}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="date" name="expiry_date" id="expiry_date" required="" value="{{$product->expiry_date}}">
                            </div>
