...
<body class="app">   	
    ...
    <div class="app-wrapper">
        ...
        <div class="card">
            <div class="card-header"><a href="{{ route('show_product') }} " class="btn btn-link bg-warning text-white">All Products</a></div>
                <div class="card-body">
                                ...
                                @foreach ($product->sizes as $size)
                                    @if ($size->flavor_id == $flavor->id)
                                        <tr class="{{ $product->quantity == 0 ? 'out-of-stock' : '' }}">
                                            ...
                                            <td>{{ $flavor->name }}</td>
                                            <td>{{ $size->size }}</td> <!-- Display size for each row -->
                                            <td>{{ $size->price }}</td> <!-- Display price for each size -->
                                            <td>{{ $size->stock_quantity }}</td> <!-- Display stock quantity for each size -->
                                            ...
                                            <td>
                                                ...
                                                @elseif (Carbon::parse($product->expiry_date)->isBetween(Carbon::today(), Carbon::today()->addDays(5)))
                                                    <span class="label label-warning" style="color: orange; font-weight: bold;">
                                            ...
                                            <td><a class="btn btn-secondary" href="{{url('sale')}}">
                                                <i class="fa fa-tags text-white"></i></a>
                                            </td>
                                            <td>
