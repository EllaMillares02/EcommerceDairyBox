    ...
    <div class="app-wrapper">
        ...
        <div class="card">
            <div class="card-header">All Products 
                <a href="{{ route('nearExpiry_product') }}" class="btn btn-link bg-warning text-white" style="float: right">
                Near to Expire Products
                <span class="badge bg-danger rounded-circle" style="position: relative; top: -10px; left: -5px;"> {{ $productToExpireCount }}</span>
            </a></div>
                <div class="card-body">
